...
templates['emailsInOverview'] = template(function (Handlebars,depth0,helpers,partials,data) {
...
function program3(depth0,data) {
  ...
  buffer += "\n        ";
  stack1 = depth0;
  stack1 = self.invokePartial(partials.email, 'email', stack1, helpers, partials);;
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n      ";
  return buffer;}

  buffer += "<div class=\"project\" id=\"project";
  ...
  foundHelper = helpers.emailCount;
  if (foundHelper) { stack1 = foundHelper.call(depth0, {hash:{}}); }
  else { stack1 = depth0.emailCount; stack1 = typeof stack1 === functionType ? stack1() : stack1; }
